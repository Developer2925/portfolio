        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center lg:p-8">
            <img
              src={profilePic}
              alt=""
              className="lg:w-4/5 px-8 pt-8 border border-stone-900 rounded-3xl bg-black "
            />
          </div>
        </div>
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start mt-10">
            ...
            <a
              href="/Om_Dhakulkar_CV.pdf"
              target="_blank"
              rel="noopener noreferrer"
              download
              className="bg-white rounded-full px-4 py-3 text-sm text-stone-800 mb-10"
            >
              Download Resume
            </a>
          </div>
